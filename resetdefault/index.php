...
<h1> Admin Only. Use this change the default user password (Note: This only affects people newly added). </h1>
        ...
        if (isset($_POST['new_pswd']) && isset($_POST['pswd'])) {
            ...
            if (password_verify($_POST['pswd'], $row['pswd'])) {
                ...
                if(1==2){
                    ...
                    $sqlprp = $conn_id->prepare("UPDATE timeMan_auth set pswd = ? WHERE user = 'user'");
